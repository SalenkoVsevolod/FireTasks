...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sPref = getSharedPreferences(getString(R.string.sharedPreferencesFileName), MODE_PRIVATE);
        String savedId = sPref.getString(getString(R.string.ID_SHARED_KEY), null);
        if (savedId != null) {
            startTasksActivity();
        }
        ...
        if (requestCode == 18) {
            ...
            if (result.isSuccess()) {
                ...
                if (account != null && account.getId() != null) {
                    ed.putString(getString(R.string.ID_SHARED_KEY), account.getId());
                    ed.apply();
                }
